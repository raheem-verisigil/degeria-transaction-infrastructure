...
import { DEMO_TRANSACTION, getCoreMode, submitEvaluation, type EvaluationRequest } from "../lib/degeria-core";
const blue = "#2d7dff";
const teal = "#43d9c5";
...
<<<<<<< HEAD
  en: { eyebrow: "Economic Transaction Infrastructure", title: "Make the transaction", emphasis: "understandable", titleEnd: ".", question: "From imported inputs to production, export, shipment, receivable and payment.", lede: "DEĞERIA turns fragmented industrial, trade, production and financial evidence into a structured Transaction Passport — connecting the whole economic transaction, not just the order.", primary: "Build a Transaction Passport", secondary: "See how it works", explore: "Explore the infrastructure" },
  tr: { eyebrow: "Ekonomik İşlem Altyapısı", title: "İşlemi", emphasis: "anlaşılır kılın", titleEnd: ".", question: "İthal girdilerden üretime, ihracata, sevkiyata, alacağa ve ödemeye kadar.", lede: "DEĞERIA; dağınık sınai, ticari, üretim ve finansal kanıtları yapılandırılmış bir İşlem Pasaportunda birleştirir — yalnızca siparişi değil, tüm ekonomik işlemi bağlar.", primary: "Bir İşlem Pasaportu oluşturun", secondary: "Nasıl çalıştığını görün", explore: "Altyapıyı keşfedin" },
  ar: { eyebrow: "بنية تحتية للمعاملات الاقتصادية", title: "اجعل المعاملة", emphasis: "مفهومة", titleEnd: ".", question: "من المدخلات المستوردة إلى الإنتاج والتصدير والشحن والمستحقات والدفع.", lede: "تحوّل DEĞERIA الأدلة الصناعية والتجارية والإنتاجية والمالية المتناثرة إلى جواز معاملة منظم — يربط المعاملة الاقتصادية بأكملها، وليس الطلب فقط.", primary: "أنشئ جواز معاملة", secondary: "شاهد كيف يعمل", explore: "استكشف البنية التحتية" },
  de: { eyebrow: "Wirtschaftliche Transaktionsinfrastruktur", title: "Machen Sie die Transaktion", emphasis: "verständlich", titleEnd: ".", question: "Von importierten Vorleistungen über Produktion, Export, Versand, Forderung bis zur Zahlung.", lede: "DEĞERIA verbindet fragmentierte industrielle, Handels-, Produktions- und Finanznachweise zu einem strukturierten Transaktionspass — er verknüpft die gesamte wirtschaftliche Transaktion, nicht nur die Bestellung.", primary: "Einen Transaktionspass erstellen", secondary: "So funktioniert es", explore: "Infrastruktur erkunden" },
  it: { eyebrow: "Infrastruttura per Transazioni Economiche", title: "Rendi la transazione", emphasis: "comprensibile", titleEnd: ".", question: "Dagli input importati alla produzione, esportazione, spedizione, credito e pagamento.", lede: "DEĞERIA trasforma le evidenze industriali, commerciali, produttive e finanziarie frammentate in un Passaporto della Transazione strutturato — collegando l'intera transazione economica, non solo l'ordine.", primary: "Crea un Passaporto della Transazione", secondary: "Scopri come funziona", explore: "Esplora l'infrastruttura" },
  zh: { eyebrow: "经济交易基础设施", title: "让交易", emphasis: "清晰可懂", titleEnd: "。", question: "从进口投入到生产、出口、运输、应收账款和付款。", lede: "DEĞERIA 将分散的工业、贸易、生产和金融证据，转化为结构化的交易护照——连接整个经济交易，而不仅仅是订单。", primary: "创建交易护照", secondary: "了解运作方式", explore: "探索基础设施" },
  fr: { eyebrow: "Infrastructure de Transaction Économique", title: "Rendez la transaction", emphasis: "compréhensible", titleEnd: ".", question: "Des intrants importés à la production, l'exportation, l'expédition, la créance et le paiement.", lede: "DEĞERIA transforme les preuves industrielles, commerciales, de production et financières fragmentées en un Passeport de Transaction structuré — reliant l'ensemble de la transaction économique, pas seulement la commande.", primary: "Créer un Passeport de Transaction", secondary: "Voir comment ça marche", explore: "Explorer l'infrastructure" },
  pt: { eyebrow: "Infraestrutura de Transação Econômica", title: "Torne a transação", emphasis: "compreensível", titleEnd: ".", question: "Desde insumos importados até produção, exportação, embarque, recebível e pagamento.", lede: "A DEĞERIA transforma evidências industriais, comerciais, de produção e financeiras fragmentadas em um Passaporte de Transação estruturado — conectando toda a transação econômica, não apenas o pedido.", primary: "Criar um Passaporte de Transação", secondary: "Veja como funciona", explore: "Explorar a infraestrutura" },
=======
  en: { eyebrow: "Economic transaction infrastructure", title: "Make the transaction", emphasis: "understandable.", titleEnd: "", question: "From import and production to export, shipment, receivable and payment.", lede: "DEĞERIA turns fragmented industrial, trade and financial evidence into a structured, traceable Economic Transaction Passport—built for manufacturers and designed for finance, insurance and institutional workflows.", primary: "Build a Transaction Passport", secondary: "See how it works", explore: "Explore the infrastructure" },
  tr: { eyebrow: "Ekonomik işlem altyapısı", title: "İşlemi", emphasis: "anlaşılır hâle getirin.", titleEnd: "", question: "İthal girdilerden üretime, ihracattan sevkiyata, alacaktan ödemeye.", lede: "DEĞERIA; dağınık endüstriyel, ticari ve finansal kanıtları üreticiler için yapılandırılmış, izlenebilir bir Ekonomik İşlem Pasaportunda birleştirir.", primary: "İşlem Pasaportu oluşturun", secondary: "Nasıl çalıştığını görün", explore: "Altyapıyı keşfedin" },
  ar: { eyebrow: "بنية تحتية للمعاملات الاقتصادية", title: "اجعل المعاملة", emphasis: "مفهومة.", titleEnd: "", question: "من الاستيراد والإنتاج إلى التصدير والشحن والمستحقات والدفع.", lede: "تحول DEĞERIA الأدلة الصناعية والتجارية والمالية المتفرقة إلى جواز معاملة اقتصادية منظم وقابل للتتبع.", primary: "أنشئ جواز معاملة", secondary: "شاهد كيف تعمل", explore: "استكشف البنية التحتية" },
  de: { eyebrow: "Infrastruktur für Wirtschaftstransaktionen", title: "Machen Sie die Transaktion", emphasis: "verständlich.", titleEnd: "", question: "Von Import und Produktion über Export und Versand bis Forderung und Zahlung.", lede: "DEĞERIA verwandelt fragmentierte industrielle, handelsbezogene und finanzielle Nachweise in einen strukturierten, nachvollziehbaren Wirtschaftstransaktionspass.", primary: "Transaktionspass erstellen", secondary: "Funktionsweise ansehen", explore: "Infrastruktur erkunden" },
  it: { eyebrow: "Infrastruttura delle transazioni economiche", title: "Rendi la transazione", emphasis: "comprensibile.", titleEnd: "", question: "Dall'importazione e produzione all'esportazione, spedizione, credito e pagamento.", lede: "DEĞERIA trasforma le evidenze industriali, commerciali e finanziarie frammentate in un Passaporto della Transazione Economica strutturato e tracciabile.", primary: "Crea un Passaporto della Transazione", secondary: "Scopri come funziona", explore: "Esplora l'infrastruttura" },
  zh: { eyebrow: "经济交易基础设施", title: "让交易变得", emphasis: "清晰可理解。", titleEnd: "", question: "从进口和生产，到出口、装运、应收账款和付款。", lede: "DEĞERIA 将分散的工业、贸易和金融证据，转化为结构化、可追溯的经济交易护照。", primary: "创建交易护照", secondary: "了解工作方式", explore: "探索基础设施" },
  fr: { eyebrow: "Infrastructure des transactions économiques", title: "Rendez la transaction", emphasis: "compréhensible.", titleEnd: "", question: "De l'importation et la production à l'exportation, l'expédition, la créance et le paiement.", lede: "DEĞERIA transforme les preuves industrielles, commerciales et financières fragmentées en un Passeport de Transaction Économique structuré et traçable.", primary: "Créer un Passeport de Transaction", secondary: "Voir comment cela fonctionne", explore: "Explorer l'infrastructure" },
  pt: { eyebrow: "Infraestrutura de transações econômicas", title: "Torne a transação", emphasis: "compreensível.", titleEnd: "", question: "Da importação e produção à exportação, embarque, recebível e pagamento.", lede: "A DEĞERIA transforma evidências industriais, comerciais e financeiras fragmentadas em um Passaporte de Transação Econômica estruturado e rastreável.", primary: "Criar um Passaporte de Transação", secondary: "Ver como funciona", explore: "Explorar a infraestrutura" },
>>>>>>> c526e13e1e220cba00f3119f9d29d68639e24c2a
};
...
const graphNodes = [
  ...
  { label: "EXPORT", detail: "Export order", value: "87%", source: "Export evidence", status: "CALCULATED" },
  { label: "SHIPMENT", detail: "Logistics & delivery", value: "In transit", source: "Freight documentation", status: "OBSERVED" },
  ...
  { label: "PAYMENT", detail: "Settlement event", value: "Pending", source: "Outcome stream", status: "PREDICTED" },
...
<<<<<<< HEAD
    <div className="visual-caption"><span className="live-dot" />ILLUSTRATIVE DEMO — SYNTHETIC TRANSACTION</div>
=======
    <div className="visual-caption"><span className="live-dot" />ILLUSTRATIVE DEMO · SYNTHETIC TRANSACTION</div>
>>>>>>> c526e13e1e220cba00f3119f9d29d68639e24c2a
  </div>;
...
function FragmentedEvidence() {
  ...
  return <section className="section dark-section problem-section" id="mechanism"><div className="container"><SectionLabel index="02" light>Why a transaction needs structure</SectionLabel><div className="split-heading"><h2>Important transactions rarely live in <em>one system.</em></h2><p>The contract may be in email. The BOM may be in the ERP. Supplier costs may be in spreadsheets. Shipment and payment evidence arrive later. DEĞERIA does not replace these systems—it connects the economic evidence they produce.</p></div><div className="fragment-map"><div className="source-stack">{sources.map((source, index) => <div className={`source-chip source-${index}`} key={source}><span>{String(index + 1).padStart(2, "0")}</span>{source}</div>)}</div><div className="map-threads">{sources.slice(0, 6).map((_, index) => <i key={index} style={{ "--i": index } as React.CSSProperties} />)}</div><div className="question-node"><span>?</span><small>ECONOMIC<br />CONTEXT</small></div><div className="degeria-reveal"><div className="reveal-top"><span className="brand-symbol small"><span /></span><span>DEĞERIA</span></div><strong>Evidence →<br /><em>Structured Transaction Passport</em></strong><ArrowRight size={18} /></div></div></div></section>;
}

function Invention() {
  const layers = ["ERP", "PRODUCTION", "SUPPLIER", "LOGISTICS", "ACCOUNTING", "IMPORT", "EXPORT", "BANK", "INSURANCE"];
  return <section className="section invention-section"><div className="container"><SectionLabel index="03">The invention</SectionLabel><div className="invention-heading"><h2>We don't replace the systems that run the factory.</h2><h2 className="accent-line">We create the economic transaction representation between them.</h2></div><div className="invention-diagram"><div className="system-orbit">{layers.map((layer, index) => <span key={layer} style={{ "--index": index } as React.CSSProperties}>{layer}</span>)}</div><div className="invention-center"><span className="brand-symbol"><span /></span><b>DEĞERIA</b><small>economic evidence layer</small></div><div className="invention-output"><Network size={18} /><span>STRUCTURED TRANSACTION<br /><b>PASSPORT</b></span></div></div><div className="invention-footer"><p>DEĞERIA sits above fragmented enterprise and transaction systems, organizing the evidence into one structured, traceable representation. Existing systems remain systems of record.</p><ArrowLink href="#passport">See how the Passport works</ArrowLink></div></div></section>;
}

function TransactionChain() {
  const stages = ["IMPORT INPUTS", "PRODUCTION", "EXPORT", "SHIPMENT", "RECEIVABLE", "PAYMENT"];
...
export function ManufacturersPage() {
  return <SubpageShell eyebrow="For manufacturers" title={<>Your transaction is more than an <em>order number.</em></>} intro="Understand the full economic position of important orders—from imported input through production, export, shipment, receivable and payment."><section className="subpage-section"><div className="container"><div className="manufacturer-flow">{["IMPORT", "PRODUCTION", "EXPORT", "SHIPMENT", "RECEIVABLE", "PAYMENT"].map((item, i) => <div key={item}><span>0{i + 1}</span><b>{item}</b>{i < 5 && <ArrowRight size={18} />}</div>)}</div><div className="benefit-grid">{["Know your economic position", "See cash requirements", "Understand payment exposure", "Trace important evidence", "Compare scenarios", "Prepare institutional review files", "Measure prediction vs reality"].map((item, i) => <div key={item}><span>0{i + 1}</span><h3>{item}</h3><CheckCircle2 size={17} /></div>)}</div><div className="subpage-cta"><h2>Start with one real transaction.</h2><p>No ERP replacement required.</p><Link href="/evaluate" className="button button-primary">Evaluate one real transaction <ArrowUpRight size={16} /></Link></div></div></section></SubpageShell>;
}
...
export function EvaluatePage() {
  ...
  const submit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    setSubmitting(true);
    try {
      const request: EvaluationRequest = { company: String(form.get("company") || ""), country: String(form.get("country") || ""), industry: String(form.get("industry") || ""), transactionType: transactionTypeMap[String(form.get("type") || "")] || "EXPORT", transactionSize: String(form.get("size") || ""), paymentTerm: String(form.get("payment") || ""), objectives: selected };
      const result = await submitEvaluation(request);
      if (result.ok) setSubmitted(true);
      else setError("This site is currently in pilot demo mode. No request was sent because the DEĞERIA API is not configured yet.");
    } catch (err) {
